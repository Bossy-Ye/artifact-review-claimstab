...
**This is the manuscript-facing L3 diagnostic for the RQ3 controlled
validation suite.** It supersedes an earlier four-regime / 20-instance L3
diagnostic, which is not bundled; the two are **not** combined or
double-counted in the RQ3 summary. This diagnostic's outputs are
