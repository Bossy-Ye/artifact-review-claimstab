...
def tracked_markdown_files() -> list[Path]:
    ...
    # Include all newly created Markdown before it is tracked. This matters during
    # artifact preparation, when reviewer docs are commonly checked pre-commit.
    for candidate in REPO_ROOT.rglob("*.md"):
        ...
        if candidate not in paths and not ignored:
