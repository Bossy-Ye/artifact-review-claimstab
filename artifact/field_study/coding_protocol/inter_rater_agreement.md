...
Note: an earlier, smaller 50-item smoke check (with degenerate one-class $\kappa$ on
some fields) was used internally during development. It is **not** the paper-facing
coding-validity evidence and has been quarantined out of the reviewer artifact; use
the 120-item package above.
